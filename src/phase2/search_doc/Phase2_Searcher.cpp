...
void Phase2_Searcher::intersection()
{
    // added by Susen
...
void Phase2_Searcher::print_vid()
{
    ofstream fout;
...
void Phase2_Searcher::intersection1()
{
    // begin timing
    ...
    for (i=0; i<term_number; i++) // deal with each query term
    {
        ...
        vector<Fid_Occurence> *vector_occ = &(search_frag[i]);
        ...
        sort(current_posting.begin(), current_posting.end(), V_Occurence::compare);
